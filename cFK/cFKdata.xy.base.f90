...
INTEGER, PARAMETER :: N=60, Nsim=60, channelWL=100
...
REAL(KIND=BR), PARAMETER :: a=0.41*WL!*REAL(channelWL)/REAL(Nsim)
...
REAL(KIND=BR), PARAMETER :: ySpringScale = 0.0
...
INTEGER, PARAMETER :: printingWidthReals=9
...
LOGICAL, PARAMETER :: WRITEX=.true.,WRITEV=.true.
