...
INTEGER, PARAMETER :: positioningDuration = 1e6, positioningOn=5e5
...
INTEGER, PARAMETER :: KINKS=4, ONEBREATHER=5
...
INTEGER, PARAMETER :: WRITESTATEWAIT=5000, corWindow=floor(1.0/(dt*1.0e9*0.513*10.0))
