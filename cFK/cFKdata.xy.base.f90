...
REAL, PARAMETER :: T=1.0e-9, dt=2.0*1.0000e-15
...
REAL(KIND=BR), PARAMETER :: positioningMultiplier = 0.00, positioningMove=positioningMultiplier*lambda
REAL(KIND=BR), PARAMETER :: positioningdx = positioningMove / real(positioningDuration)
...
INTEGER, PARAMETER :: KINKS=4, ONEBREATHER=5, FVDM=6
...
INTEGER, PARAMETER :: WRITESTATEWAIT=100, corWindow=floor(1.0/(dt*1.0e9*0.513*10.0))
