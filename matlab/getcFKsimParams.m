...
[~,GrampStr]=system(['awk "/ Gramp:/ {print \$2; exit}" <' logfile]);
cFKparams.Framp=str2num(GrampStr);
...
cFKparams.allStr=[  'h: ' sprintf('%.1e',c.h/1.38e-23) ' K\n'...
                    ...
                    'N: ' num2str(c.N) '\n'...
                    'L: ' num2str(c.L) '\n'...
                    'a: ' num2str(c.a*1e10) ' ' angstrom ' ( ' num2str(100*c.a/c.lambda) '%% )\n'...
                    'l: ' num2str(c.WL*1e10) ' ' angstrom '\n'...
                    'Force: ' num2str(c.F) ' N\n'...
                    'Force ramp: ' num2str(c.Framp) ' steps\n'...
